      ...
      case 'basic-rules-quiz':
        return (
          <div className="space-y-4">
            <h3 className={`text-xl font-semibold ${themeClasses.text}`}>Prove your fundamentals</h3>
            <p className={themeClasses.textSecondary}>
              This quiz pulls a fresh mix of core 21 rules every attempt. Answer every question correctly in one run to mark the
              module complete and unlock the next lesson.
            </p>
          </div>
        );
